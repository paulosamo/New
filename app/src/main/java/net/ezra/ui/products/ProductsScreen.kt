        ...
        Box {
            Column(
                ...
                Text(
                    ...
                    text = "Go home",
                    color = Color(0xff23D342)
                )

                Spacer(modifier = Modifier.height(10.dp))

                // Your existing Card composable code here...

                Spacer(modifier = Modifier.height(15.dp))

                // Your existing LazyColumn composable code here...

                // Button to open wound products website
                IconButton(
                    onClick = {
                        // Replace "https://example.com" with the actual URL of your wound products website
                        ("https://woundproducts.com")
                    },
                    modifier = Modifier.padding(vertical = 10.dp)
                ) {
                    Text(text = "Wound Products Website")
                }
            }
        }
    }
