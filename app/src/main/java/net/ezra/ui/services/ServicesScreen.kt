...
//                        ) {
//                            Text(
//                                text = "Assessment: Thorough evaluation of the wound's size, depth, severity, and any underlying conditions that may affect healing.\n" +
//                                        "\n" +
...
//                            Card {
//                                Text(
//                                    text = "Preventing wound infection is crucial for proper healing and overall health. Here are some ways to avoid wound infection:\n" +
//                                            "\n" +
...
//                                    TextButton(onClick = {
//                                        // Open the website
//                                        val url = "https://www.kutrrh.go.ke/service/wound-care-clinic/"
//                                        navController.navigate(ROUTE_SERVICES + "/www.kutrrh.go.ke/service/wound-care-clinic=$")
//                                    }) {
//                                        Text("click here")
//                                    }
//                                }
        ...
        item {
            Card(
                ...
                Card {
                    ...
                    TextButton(onClick = {
                        // Open the website
                        val url = "https://medlineplus.gov/ency/patientinstructions/000739.htm"
                        navController.navigate(ROUTE_SERVICES + "/https://medlineplus.gov/ency/patientinstructions/000739.htm")
                    }) {
                        Text("Click here to visit the website for services")
                    }
                }
            }
        }
